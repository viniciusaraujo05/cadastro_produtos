...
<amp-sidebar id="sidebar" class="sample-sidebar" layout="nodisplay" side="left">
  ...
  <a href="app/views/dashboard.php"><img src="<?=BASE_URL?>app/views/images/menu-go-jumpers.png" alt="Welcome" width="200" height="43" /></a>
  <div>
    <ul>
      <li><a href="app/views/categories.php" class="link-menu">Categorias</a></li>
      <li><a href="app/views/products.php" class="link-menu">Produtos</a></li>
    </ul>
  </div>
</amp-sidebar>
<header>
