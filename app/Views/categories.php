...
<link  rel="stylesheet" type="text/css"  media="all" href="<?php echo BASE_URL; ?>app/views/css/style.css" />
...
<amp-sidebar id="sidebar" class="sample-sidebar" layout="nodisplay" side="left">
  ...
  <a href="<?=BASE_URL?>app/views/dashboard.php"><img src="<?=BASE_URL?>app/views/images/menu-go-jumpers.png" alt="Welcome" width="200" height="43" /></a>
  <div>
    <ul>
...
<!-- Header --><body>
  ...
  <main class="content">
    <div class="header-list-page">
      ...
      <a href="<?=BASE_URL?>app/views/addCategory.php" class="btn-action">Add new Category</a>
    </div>
